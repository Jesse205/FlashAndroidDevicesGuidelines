...
<!--@include: ./font/hmos_sans_fragment.md -->

#### HONOR Sans <Badge text="MagicOS 最新" />

<!--@include: ./font/honor_sans_fragment.md -->
...
| 版本                  | 行为                                                                                                          |
| --------------------- | ------------------------------------------------------------------------------------------------------------- |
| EMUI 4 - Harmony OS 4 | 若 `Intent#createChooser(Intent target, CharSequence title)` 的 `title` 参数不为空时，显示自己的 Sharesheet。 |
